...
bool ktra_tgian_hc(PTR_CB& CB, PTR_CB& p, DATE_TIME& date_time, char* a);

bool ktra_tgian(DATE_TIME& d1, DATE_TIME& d2);
...
bool ktra_SHMB(PTR_CB CB, PTR_CB& q, DATE_TIME& date_time);

bool ktra_tgian_SHMB(DATE_TIME& d1, DATE_TIME d2);

//bool ktra_SBden(PTR_CB CB, PTR_CB p);
...
////		DAT VE 			//////
bool CB_1H_APART(PTR_CB a, PTR_CB b, int m);
...
void Nhap_infoHK(PTR_HK Root,infoHK& infohk, int x, int y);
...
int TIM_VE(PTR_CB p, char *cm);
void delete_ve(PTR_CB& p, char* cm);
//void HuyVE(PTR_CB& First, PTR_HK Root);
void HUYVE_THEO_MACB(PTR_CB& First, PTR_HK Root);
...
///      	DANH SACH CHUYEN BAY THEO THOI GIAN VA SAN BAY DEN			/////
...
{
	PTR_CB k;
	for (PTR_CB q = CB; q != NULL; k=q,q = q->next)
	{
		if (q != p)
		{
				...
				strcmp(a, q->infocb.san_bay_den) == 0)
			{
				...
				{
					if (abs(q->infocb.date_time.gio * 60 + q->infocb.date_time.phut
						- date_time.gio * 60 - date_time.phut) < 30) return 0;
				}
			}
			...
			else if (abs(date_time.ngay - q->infocb.date_time.ngay) == 1)
			{
				if (abs(date_time.gio - q->infocb.date_time.gio) == 23)
				{
					if (date_time.gio == 0)
					{
						if (24 * 60 + date_time.phut - q->infocb.date_time.gio * 60 - q->infocb.date_time.phut < 30) return 0;
					}
					else if (q->infocb.date_time.gio == 0)
						if (24 * 60 + q->infocb.date_time.phut - date_time.gio * 60 - date_time.phut < 30) return 0;
				}
			}
			else if ((!ktra_tgian(date_time, q->infocb.date_time)) && strcmp(a, q->infocb.san_bay_den) == 0) return 0;
		}
	}
	return 1;
}
...
bool ktra_tgian(DATE_TIME& d1, DATE_TIME &d2)
{
	...
	case 10:
	{
		if (d1.ngay == 31 && d2.ngay == 1 && d2.thang == d1.thang + 1 && d1.nam == d2.nam)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
				{
					if (24 * 60 + d1.phut - d2.gio * 60 - d2.phut < 30) return 0;
				}
				else if (d2.gio == 0)
					if (24 * 60 + d2.phut - d1.gio * 60 - d1.phut < 30) return 0;
			}
		}
		break;	
	}
	...
	case 11:
	{
		if (d1.ngay == 30 && d2.ngay == 1 && d2.thang == d1.thang + 1 && d1.nam == d2.nam)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
	...
	case 2:
	{
		if (la_nam_nhuan(d1.nam))
		{
			if (d1.ngay == 29 && d2.ngay == 1 && d2.thang == d1.thang + 1 && d1.nam == d2.nam)
			{
				if (abs(d1.gio - d2.gio) == 23)
				{
					if (d1.gio == 0)
		...
		{
			if (d1.ngay == 28 && d2.ngay == 1 && d2.thang == d1.thang + 1 && d1.nam == d2.nam)
			{
				if (abs(d1.gio - d2.gio) == 23)
				{
					if (d1.gio == 0)
	...
	case 12:
	{
		if (d1.ngay == 31 && d2.ngay == 1 && d2.thang == 1 && d1.nam == d2.nam - 1)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
	...
	case 10:
	{
		if (d2.ngay == 31 && d1.ngay == 1 && d1.thang == d2.thang + 1 && d1.nam == d2.nam)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
	...
	case 11:
	{
		if (d2.ngay == 30 && d1.ngay == 1 && d1.thang == d2.thang + 1 && d1.nam == d2.nam)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
	...
	case 2:
	{
		if (la_nam_nhuan(d2.nam))
		{
			if (d2.ngay == 29 && d1.ngay == 1 && d1.thang == d2.thang + 1 && d1.nam == d2.nam)
			{
				if (abs(d1.gio - d2.gio) == 23)
				{
					if (d1.gio == 0)
		...
		{
			if (d2.ngay == 28 && d1.ngay == 1 && d1.thang == d2.thang + 1 && d1.nam == d2.nam)
			{
				if (abs(d1.gio - d2.gio) == 23)
				{
					if (d1.gio == 0)
	...
	case 12:
	{
		if (d2.ngay == 31 && d1.ngay == 1 && d1.thang == 1 && d2.nam == d1.nam - 1)
		{
			if (abs(d1.gio - d2.gio) == 23)
			{
				if (d1.gio == 0)
	...
	do
	{
		...
		if (k == -32)
		{
			...
			else if (k == trai && i > 10)
			{
				...
				if (i != 10)
				{
					i = i - 10 - ((i % 10 == 0) ? 10 : (i % 10));
					y = y3 - 1;
					kt = i + 10;
					so--;
					gotoxy(x + 38, y1 + 1); cout << so;
					if (r - 10 >= 0)r = r - 10;
					for (int j = y3; j < y3 + 20; j++)
					{
						gotoxy(x, j);
...
bool ktra_SHMB(PTR_CB CB, PTR_CB& q,DATE_TIME &date_time)
{
	...
	for (PTR_CB p = CB; p != NULL; p = p->next)
	{
		if (p!=q)
		{
			if (p->infocb.date_time.thang == date_time.thang && p->infocb.date_time.nam == date_time.nam && (strcmp(p->infocb.shMB, q->infocb.shMB) == 0))
			{
				if (abs(p->infocb.date_time.gio * 60 + p->infocb.date_time.phut - date_time.gio * 60 - date_time.phut) < 300 &&
					p->infocb.date_time.ngay == date_time.ngay) return 0;
				else if (abs(p->infocb.date_time.ngay - q->infocb.date_time.ngay) == 1)
				{
					if (p->infocb.date_time.gio == 19 || p->infocb.date_time.gio == 20 || p->infocb.date_time.gio == 21 || p->infocb.date_time.gio == 22 || p->infocb.date_time.gio == 23)
					{
						if ((p->infocb.date_time.gio + 5) * 60 - 24 * 60 + p->infocb.date_time.phut > date_time.gio * 60 + date_time.phut) return 0;
					}
					else if (date_time.gio == 19 || date_time.gio == 20 || date_time.gio == 21 || date_time.gio == 22 || date_time.gio == 23)
					{
						if ((date_time.gio + 5) * 60 - 24 * 60 + date_time.phut > p->infocb.date_time.gio * 60 + p->infocb.date_time.phut) return 0;
					}
				}
			}
			else if (strcmp(p->infocb.shMB, q->infocb.shMB) == 0)
			{
				if (ktra_tgian_SHMB(date_time, p->infocb.date_time))
					continue;
				else return 0;
			}
		}
...
bool ktra_tgian_SHMB(DATE_TIME& d1, DATE_TIME d2)
{
	...
	case 10:
	{
		if (d1.ngay == 31 && d2.ngay == 1 && d2.thang == d1.thang + 1 && d1.nam == d2.nam)
		{
			if (d1.gio == 19 || d1.gio == 20 || d1.gio == 21 || d1.gio == 22 || d1.gio == 23)
			{
				if ((d1.gio + 5) * 60 - 24 * 60 + d1.phut > d2.gio * 60 + d2.phut) return 0;
			}
			else if (d2.gio == 19 || d2.gio == 20 || d2.gio == 21 || d2.gio == 22 || d2.gio == 23)
			{
				if ((d2.gio + 5) * 60 - 24 * 60 + d2.phut > d1.gio * 60 + d1.phut) return 0;
			}
		}
		break;
	}
	...
	case 12:
	{
		if (d2.ngay == 31 && d1.ngay == 1 && d1.thang == 1 && d1.nam == d2.nam + 1)
		{
			if (d1.gio == 19 || d1.gio == 20 || d1.gio == 21 || d1.gio == 22 || d1.gio == 23)
			{
				if ((d1.gio + 5) * 60 - 24 * 60 + d1.phut > d2.gio * 60 + d2.phut) return 0;
...
//	{
//		if ((!ktra_tgian(p->infocb.date_time, p1->infocb.date_time))) return 0;
		...
		do
		{
			...
			else if (k == enter)
			{
				...
				case 7:
				{
					...
					{
						bool kt_SBD = ktra_tgian_hc(CB, p, p->infocb.date_time, p->infocb.shMB), kt_shMB = ktra_SHMB(CB, p, p->infocb.date_time);
						if (kt_SBD && kt_shMB)
						{
						...
						else
						{
							...
							{
								gotoxy(x + strlen(h[0]) + 40, y + 7);
								cout << "CAC CHUYEN BAY CUNG SAN BAY PHAI CACH NHAU 30 PHUT";
							}
							else
							{
								gotoxy(x + strlen(h[0]) + 40, y + 10);
		...
		while (1)
		{
			...
			else if (k == enter)
			{
				if (i == 6)
				{
					...
					{
						bool ktra_tgian_HC = ktra_tgian_hc(CB, p, date_time,p->infocb.shMB);
						bool ktra_shmb = ktra_SHMB(CB, p, date_time);
						if (ktra_tgian_hc &&ktra_shmb)
						{
						...
						{
							gotoxy(x + 114, y + 13);
							cout << "CAC CHUYEN BAY CUNG SAN BAY PHAI CACH NHAU 30 PHUT HOAC DA TRUNG MAY BAY";
							Sleep(3000);
							gotoxy(x + 114, y + 13);
							cout << "                                                                        ";
						}
...
int chon_cb(char** dsmacb,  int x, int y, int dem, int h, int &dau) {
	...
	while (true) {
		...
		if (_kbhit()) {
			...
			else if (a == tab && strlen(dsmacb[0]) <= 3) {
				return 0 - esc;
			}
		}
	}
...
void nhap_cmnd(char* a)
{
	...
	{
		a[d] = getch();
		if (a[d] >= 48 && a[d] <= 57 && d <= 8)
		{
			cout << a[d];
			d++;
		}
		else if (d == 9 && a[d] == enter)
			break;
		/*	else if (a[d] == esc)
			{
...
PTR_CB nhap_macb(PTR_CB First) {
	...
	while (1) {
		...
		//	KE_BANG(85, 5, wcb, 5, 10, ndbang, dau);
			count = 0; yh = 2; dem = 0;
			for (PTR_CB p = First; p != NULL && count < 10; p = p->next) {
				if (dem >= dau  && (strcmp(a[sbd],p->infocb.san_bay_den) == 0 || sbd == 0)) {
				...
				if((strcmp(a[sbd], p->infocb.san_bay_den) == 0 || sbd == 0))
					dem++;
				if (p->next == NULL ) {
					if(count < 10)
					...
					while (1) {
						...
						if (k == -32) {
							...
							if (k == phai) {
								...
								bool kt2 = true; bool in_ds = false;
								while (1) {
									if (kt2 == true) {
										if (in_ds == true) {
											ShowCur(0);
											//	KE_BANG(65, 5, wcb, 7, 10, ndbang);
											firstp = 1; lastp = 0; dau = 0;
											count = 0; yh = 2; dem = 0;
											for (PTR_CB p = First; p != NULL; p = p->next) {
											...
											KE_BANG(65, 5, wcb, 7, count, ndbang);
											if (lastp == 1) {
												thanh_sang(130, 29, 7, 1, 7, 0, nex);
											}
											else {
...
bool kiemtratime(DATE_TIME d1, DATE_TIME d2, int m) {
	if ((d1.nam == d2.nam) && (d1.thang == d2.thang)) {
		int x = d1.gio * 60 + d1.phut;
		int y = d2.gio * 60 + d2.phut;
		if (abs(d1.ngay - d2.ngay) == 0 && abs(x - y) < 60) return 0;// xu li thoi gian cach nhau 1h
		if (abs(d1.ngay - d2.ngay) == 1 && abs((x - y) - 24 * 60) < 60) return 0;
	}
	else {
		DATE_TIME lon, nho;
		if (so_sanh_tgian(d1, d2)) {
			lon = d1;
			nho = d2;
		}
		else {
		...
		if (nho.phut > 59) {
			nho.gio += nho.phut / 60;
			nho.phut = nho.phut % 60;
			if (nho.gio > 23) {
				nho.ngay += nho.gio / 24;
				nho.gio = nho.gio % 24;
				if (nho.ngay > 31 && (nho.thang == 1 || nho.thang == 2 || nho.thang == 3 || nho.thang == 5 || nho.thang == 7 || nho.thang == 8 || nho.thang == 10 || nho.thang == 12)) {
					nho.thang += nho.ngay / 31;
					nho.ngay = nho.ngay % 31;
					if (nho.thang > 12) {
						nho.nam += nho.thang / 12;
						nho.thang = nho.thang % 12;
					}
				}
				if (nho.ngay > 30 && (nho.thang == 4 || nho.thang == 2 || nho.thang == 6 || nho.thang == 9 || nho.thang == 11)) {
					nho.thang += nho.ngay / 30;
					nho.ngay = nho.ngay % 30;
					if (nho.thang > 12) {
						nho.nam += nho.thang / 12;
						nho.thang = nho.thang % 12;
					}
				}
				if (nho.ngay > 29 && nho.thang == 2 && la_nam_nhuan(nho.nam)) {
					nho.thang += nho.ngay / 29;
					nho.ngay = nho.ngay % 29;
					/*if (nho.thang > 12) {
						nho.nam += nho.thang / 12;
						nho.thang = nho.thang % 12;
					}*/
				}
				if (nho.ngay > 28 && nho.thang == 2 && !la_nam_nhuan(nho.nam)) {
					nho.thang += nho.ngay / 29;
					nho.ngay = nho.ngay % 29;
					/*if (nho.thang > 12) {
						nho.nam += nho.thang / 12;
...
bool CB_1H_APART(PTR_CB a, PTR_CB b, int m) {
	if ((a->infocb.date_time.nam == b->infocb.date_time.nam) && (a->infocb.date_time.thang == b->infocb.date_time.thang)) {
		...
		DATE_TIME lon, nho;
		if (so_sanh_tgian(a->infocb.date_time, b->infocb.date_time)) {
			lon = a->infocb.date_time;
			nho = b->infocb.date_time;
		}
		else {
			nho = a->infocb.date_time;
			lon = b->infocb.date_time;
		}
		nho.phut += m;
		if (nho.phut > 59) {
			nho.gio += nho.phut / 60;
...
PTR_CB only_1_sametime(PTR_CB First, char* cm, PTR_CB p, PTR_CB cb_trung_1) {
	...
	for (q; q != NULL; q = q->next) {
		if ((q->infocb.date_time.nam < p->infocb.date_time.nam) && (q->infocb.date_time.thang < p->infocb.date_time.thang))
			break;
		if (q != p && CB_1H_APART(q, p,60) == 0 && only_1_onCB(q, cm) != -1 && q != cb_trung_1) {
			return q;
		}
	}
	return NULL;
...
bool CHONCHONGOI(PTR_CB p, int& g) {
	if (g == 0) {
		bool kt = true; char ic[5];
		int x = wherex(); int y = wherey();
		int xs = 0, ys, xcu, ycu, gcu;
		for (int i = 1; i <= p->infocb.dsve.gioi_han; i++) {
			if (strlen(p->infocb.dsve.ve[i]) == 0) {
				xs += x + 1 + 5*(i % 21 - 1);
				ys = y + 2 + 3 * ((i - 1) / 20);
				xcu = xs; ycu = ys; g = i; gcu = g;
				if (leng_int(g) < 3) {
					xs++; xcu++;
				}
				break;
		...
		while (1) {
			if (kt == true) {
				gotoxy(xcu - leng_int(gcu) / 3, ycu); SetColor(10); cout << gcu; SetColor(7);
				gotoxy(xs - leng_int(g) / 3, ys); HighLight(); cout << g; Normal();
				xcu = xs; ycu = ys;
				kt = false;
			}
			while (_kbhit()) {
				...
				if (a == -32) {
					a = getch();
					if (a == len && ys != y + 2 && strlen(p->infocb.dsve.ve[g - 20]) == 0) {
						gcu = g;
						g -= 20;
						ycu = ys;
						ys -= 3;
					...
					else if (a == xuong && ys != y + 2 + 3 * ((p->infocb.dsve.gioi_han - 1) / 20) && (g + 20) <= p->infocb.dsve.gioi_han) {
						if (strlen(p->infocb.dsve.ve[g + 20]) == 0) {
							gcu = g;
							g += 20;
							ycu = ys;
							ys += 3;
					...
					else if (a == trai && g % 20 != 1) {
						if (strlen(p->infocb.dsve.ve[g - 1]) == 0) {
							xcu = xs;
							gcu = g;
							g--;
							if (g % 5 == 0) xs -= 10;
					...
					else if (a == phai && (g % 20 != 0 && g != p->infocb.dsve.gioi_han)) {
						if (strlen(p->infocb.dsve.ve[g + 1]) == 0) {
							xcu = xs;
							if (g % 5 == 0) xs += 10;
							if (g % 10 == 0) {
	...
	else if (g > p->infocb.dsve.gioi_han || g < 0) return 0;
...
void Nhap_infoHK(PTR_HK Root,infoHK& infohk, int x, int y) {
	...
	gotoxy(x + 1, y + 1); cout << "SO CMND:   " << infohk.so_CMND;
	...
	int kt = 1; int icm = strlen(infohk.so_CMND); int iten = strlen(infohk.ho); 
		...
		if (ys == y + 1) {//nhap_cmnd
			...
			while (true) {
				...
				if (infohk.so_CMND[d] == -32) {
					infohk.so_CMND[d] = getch();
					if (infohk.so_CMND[d] == xuong && d == 9 ) {
						if (infohk.so_CMND[d - 1] == 32) d -= 1;
						break;
					}
				}
				else {
					if (infohk.so_CMND[d] >= 48 && infohk.so_CMND[d] <= 57 && d <= 8)
					{
					...
					else if (infohk.so_CMND[d] == enter && d == 9) {
						if (infohk.so_CMND[d - 1] == 32) d -= 1;
						break;
					}
			...
			infohk.so_CMND[d] = '\0';
			PTR_HK p = search_HK(Root, infohk.so_CMND);
			if (p != NULL) {
				ShowCur(0);
				ve_vien(x + 70, y, 50, 5, 7);
				gotoxy(x + 72, y + 2); cout << "Ho: " << p->infohk.ho;
				gotoxy(x + 72, y + 3); cout << "Ten: " << p->infohk.ten;
				gotoxy(x + 72, y + 4); cout << "Phai: " << p->infohk.phai;
				gotoxy(x + 72, y + 1); cout << "            THONG TIN CU?         ";
			}
			else {
				ShowCur(0);
				Xoa_n_BOX(x + 70, y, 50, 5, 1);	
			}
...
void DAT_VE(PTR_CB& First, PTR_HK& Root) {
	...
	p = ptrdscb_dv->pdv;
	//  case3; nhap thong tin
	XOA_MH();
	gotoxy(105, 9);
	HighLight();
	cout << " BAN DANG DAT VE TREN CHUYEN BAY ";
	Normal();
	KE_BANG(30 + 54, 10, wcb, 4, 1, ndbang);
	INinfoCB(p, 30 + 54, 9 + 4, 1);
	int ydown = 15;
	ve_vien(30 + 55, ydown, 67, 4, 7);
	gotoxy(30 + 55 + 2, ydown + 2); cout << "NHAP SO CMND : ";
	gotoxy(30 + 55 + 17, ydown + 2);
	...
	if (check == NULL) {
		...
		if (check == NULL) {
			...
			if (!SO_SANH_INFOHK(check->infohk, hk)) {
				...
				gotoxy(90, 31); cout << "  SO CMND NAY DA CO THONG TIN ROI";
		...
		if (!chon_YN(128, ydown + 4)) {
			...
			hk = check->infohk;
			Nhap_infoHK(Root,hk, 85, ydown);							/////////////////////// LOI KHI NHAP LAI CMND	///////////
			if (strlen(hk.so_CMND) == 0) {
				free_char(ndbang, 4);
				free_char(dsmacb, dem);
				PTR_dscb_DV q;
	...
	//  case 4;		/chon cho ngoi
	ve_vien(40, 4, strlen(check->infohk.ho) + strlen(check->infohk.ten) + 24, 5, 7);
	gotoxy(40 + (strlen(check->infohk.ho) + strlen(check->infohk.ten)) / 2, 5); cout << "THONG TIN HANH KHACH";
	gotoxy(42, 6); cout << "SO CMND: " << check->infohk.so_CMND;
			...
			if (only_1_sametime(First, hk.so_CMND, p, NULL) != NULL) {
				...
				do {
					...
					//}
						...
						gotoxy(x, y);
						char nd[20] = "KHONG HOP LE!"; 
						THONG_BAO(nd);
					}
				} while (1);
				strcpy(p->infocb.dsve.ve[ghe], hk.so_CMND);
...
//	gotoxy(82, 20 + 2); cout << "NHAP SO CMND: ";
//	gotoxy(102, 20 + 2);
//	nhap_cmnd(cm);
//	if (strlen(cm) == 0) {
//		return;
...
//		gotoxy(40 + (strlen(check->infohk.ho) + strlen(check->infohk.ten) )/2 , 5); cout << "THONG TIN HANH KHACH";
//		gotoxy(42, 6); cout << "CMND: " << check->infohk.so_CMND;
//		gotoxy(42, 7); cout << "HO TEN:    " << check->infohk.ho << " " << check->infohk.ten;
//		gotoxy(42, 8); cout << "PHAI:      " << check->infohk.phai;
//	struct CB_huy {
//		PTR_CB p;
...
//	strcpy(ndbang[2] , "THOI GIAN");
//	strcpy(ndbang[3] , "SO VE TRONG");
//	strcpy(ndbang[4], "GHE BAN DA DAT");
//	int wcb[5] = { 17,15,21,3,3 }; int soluong;
//	gotoxy(125, 10); SetColor(0); SetBGColor(7); cout << " CHUYEN BAY BAN DA DAT VE "; SetColor(7); SetBGColor(0);
//	if (dem >= 10) {
//		KE_BANG(85, 11, wcb, 5, 10, ndbang);
//		int yh = 2; soluong = 10;
//		for (qq = q; qq != NULL && yh / 2 - 1 < 10; qq = qq->next) {
//			INinfoCB(qq->p, 30 + 55, 12 + yh, yh / 2);
//			gotoxy(176, 12 + yh); cout << "   ";
//			gotoxy(176, 12 + yh); cout << TIM_VE(qq->p, cm);
//			yh += 2;
//		}
//		gotoxy(127, 34); cout << 1 << "/"; if (dem % 10 == 0) cout << dem / 10; else cout << (dem / 10) + 1;
//	}
//	else {
//		KE_BANG(85, 11, wcb, 5, dem, ndbang);
...
//		
//			int dau = 0; 
//			switch (chon_cb(nd, x + 48, (y + soluong*2 + 3), 3,1,dau)) {
//			case -27: {
//				k = false;
//				break;
//			}
//			case 0: {
//
//				Xoa_n_BOX(x + 48, y + soluong * 2 + 3, 20, 3, 1);
//				for (qq = q; qq != NULL; qq = qq->next) {
//					delete_ve(qq->p, cm);
//				}
//				Xoa_n_BOX(x, y - 2, 120, 50 - y, 1);
...
//							dem1 = 10;
//							if (le != 0) {
//								THEM_CUOI_BANG(85, 14 + le * 2 - 1, wcb, 5, 10 - le, ndbang);
//								le = 0;
//							}
//						}
//						else {
//							dem1 = dem - dau;
//							le = dem1;
//							XOA_CUOI_BANG(85, 14 + le * 2, wcb, 5, 10 - le, ndbang);
//						}
//						//	cout << dem1; system("pause");
...
//								gotoxy(176, 12 + yh); cout << "   ";
//								gotoxy(176, 12 + yh); cout << TIM_VE(huy->p, cm);
//								yh += 2;
//								j++;
//							}
//							i++;
...
//							delete_ve(qq->p, cm);
//							dem--;
//							Xoa_n_BOX(x, y + dem + 1, 120, 48 - y - dem - 1, 1);
...
//							}
//							if (dem > 10) {
//								KE_BANG(85, 11, wcb, 5, 10, ndbang); yh = 2;
//								for (PTR_CB_HUY qqq = q; qqq != NULL && yh / 2 - 1 < 10; qqq = qqq->next) {
//									INinfoCB(qqq->p, 30 + 55, 12 + yh, yh / 2);
//									gotoxy(176, 12 + yh); cout << "   ";
//									gotoxy(176, 12 + yh); cout << TIM_VE(qqq->p, cm);
//									yh += 2;
//								}
//								gotoxy(127, 34); cout << 1 << "/"; if (dem % 10 == 0) cout << dem / 10; else cout << (dem / 10) + 1;
//							}
//							else {
//								KE_BANG(85, 11, wcb, 5, dem, ndbang); yh = 2;
//								for (PTR_CB_HUY qqq = q; qqq != NULL && yh / 2 - 1 < 10; qqq = qqq->next) {
//									INinfoCB(qqq->p, 30 + 55, 12 + yh, yh / 2);
//									gotoxy(176, 12 + yh); cout << "   ";
//									gotoxy(176, 12 + yh); cout << TIM_VE(qqq->p, cm);
...
void HUYVE_THEO_MACB(PTR_CB& First, PTR_HK Root) {
	...
	if (Root== NULL) {
		char nd[30] = "HIEN CHUA CO HANH KHACH NAO!";
		BOX(80, 13, 70, 4, 7, 0, nd);
		TB_ESC();
		return;
	}
	...
	typedef HUYVE* PTR_HUYVE;
	PTR_HUYVE F = NULL;
	int dem = 0;
	for (PTR_CB p = First; p != NULL && so_sanh_tgian(p->infocb.date_time,gettime()) == 1; p = p->next) {
		if (p->infocb.dsve.ve_da_dat != 0) {
			PTR_HUYVE k = new HUYVE;
			k->q = p;
			k->next = F;
			F = k;
			dem++;
	...
	char** dscb = new char* [dem];
	PTR_HUYVE k = F; 
	for (int i = 0; i < dem; i++) {
		dscb[i] = new char[15];
		strcpy(dscb[i], k->q->infocb.maCB);
		k = k->next;
	}
	int cn = 0; PTR_CB cbhv; bool kt = true; bool flag = false; bool huytungve = false;
	while (kt) {
		switch (cn) {
		case 0: {
			if (flag == true) {
			...
			strcpy(ndbang[1], "SAN BAY DEN");
			strcpy(ndbang[2], "THOI GIAN");
			strcpy(ndbang[3], "  VE DA DAT  ");
			int wcb[4] = { 17,15,21,3 };
			int chon = -1; int yh = 2; int dau = 0; int dem1 ; int le = 0;
			if (dem >= 10) dem1 = 10;
			else dem1 = dem;
			gotoxy(70, 8);
			HighLight();
			...
			Normal();
			KE_BANG(35, 10, wcb, 4, dem1, ndbang);
			do {
				if ((dem - dau) >= 10) {
					dem1 = 10;
					if (le != 0) {
						THEM_CUOI_BANG(35, 13 + le * 2 - 1, wcb, 4, 10 - le, ndbang);
						le = 0;
					}
				}
				else {
					dem1 = dem - dau;
					le = dem1;
					XOA_CUOI_BANG(35, 13 + le * 2, wcb, 4, 10 - le, ndbang);
				}
				gotoxy(76, 33); cout << (dau / 10) + 1 << "/"; if (dem % 10 == 0) cout << dem / 10; else cout << (dem / 10) + 1;
				int i = 0; int j = 1;
				for (PTR_HUYVE hv = F; hv != NULL; hv = hv->next) {
					if (i >= dau && j <= dem1) {
						INinfoCB(hv->q, 35, 11 + yh, yh / 2 + dau);
						gotoxy(110, 11 + yh); cout << "    ";
						gotoxy(110, 11 + yh); cout << hv->q->infocb.dsve.ve_da_dat;
						yh += 2;
						j++;
					}
					i++;
				...
				yh = 2;
				chon = chon_cb(dscb, 35 + 7, 11 + 2, dem, yh, dau);
				if (chon == -27) {
					free_char(ndbang, 4);
					free_char(dscb, dem);
					PTR_HUYVE l;
			...
			for (k = F; strcmp(k->q->infocb.maCB, dscb[chon]) != 0; k = k->next);
			cbhv = k->q;
			cn++;
			free_char(ndbang,4);
			if(cbhv->infocb.dsve.ve_da_dat > 1)
				huytungve = true;
			break;
		}
		case 1: {
			if (cbhv == NULL) {
				gotoxy(2, 29); cout << "                         ";
				char nd[40] = "BAN CHUA CHON CHUYEN BAY";
				THONG_BAO(nd);
				cn = 0;
				break;
			}
			if (cbhv->infocb.dsve.ve_da_dat == 0) {
				flag = true;
				Xoa_n_BOX(122, 8, 85, 25, 1);
				gotoxy(2, 29); cout << "                         ";
				char nd[40] = "KHONG CON VE NAO";
				THONG_BAO(nd);
				cn = 0;
				break;
			}
			...
			strcpy(ndbang[3], "PHAI");
			int wcot[4] = { 3, 14, 42, 5 };
			gotoxy(142, 8); HighLight(); cout << "CHON VE DE HUY TREN CHUYEN BAY " << cbhv->infocb.maCB; Normal();
			int max = cbhv->infocb.dsve.ve_da_dat;
			char** dsve = new char* [max]; int ii = 0;
			for (int i = 1; i <= cbhv->infocb.dsve.gioi_han; i++) {
				if (strlen(cbhv->infocb.dsve.ve[i]) != 0) {
					dsve[ii] = new char[5];
					itoa(i, dsve[ii], 10);
					ii++;
				}				
			...
			KE_BANG(122, 10, wcot, 4, dem1, ndbang);
			do{
				if ((max- dau) >= 10) {
					dem1 = 10;
					if (le != 0) {
						THEM_CUOI_BANG(122, 13 + le * 2 - 1, wcot, 4, 10 - le, ndbang);
						le = 0;
					}
				}
				else {
					dem1 = max - dau;
					le = dem1;
					XOA_CUOI_BANG(122, 13 + le * 2, wcot, 4, 10 - le, ndbang);

				}
			gotoxy(168, 33); cout << (dau / 10) + 1 << "/"; if (max % 10 == 0) cout << max / 10; else cout << (max/ 10) + 1;
			int i = 0; int j = 1;
			for (i = 0; i < max; i++) {
				if (i >= dau && j <= dem1) {
					PTR_HK a;
					Lay_info(Root, cbhv->infocb.dsve.ve[atoi(dsve[i])], a);
					gotoxy(124, 11 + yh); cout << "    ";
					gotoxy(124, 11 + yh);	cout << dau + yh / 2;
					CAN_GIUA(130, 11 + yh, 5, dsve[i]);
					CAN_GIUA(138, 11 + yh, 14, a->infohk.so_CMND);
					gotoxy(157, 11 + yh);
					cout << "                                     ";
					gotoxy(157, 11 + yh);
					cout << a->infohk.ho << " " << a->infohk.ten;
			...
			yh = 2;
			if (huytungve == 1) {
				gotoxy(150, 35); cout << "BAN CO MUON HUY TAT CA VE?";
				gotoxy(150, 36); cout << "      YES: HUY TAT CA VE";
				gotoxy(150, 37); cout << "      NO : HUY TUNG VE";
				if (chon_YN(180, 35)) {
					gotoxy(150, 35); cout << "                          ";
					gotoxy(150, 36); cout << "                          ";
					gotoxy(150, 37); cout << "                          ";
					...
					Xoa_n_BOX(122, 8, 85, 25, 1);
					for (int i = 0; i < max; i++) {
						delete_ve(cbhv, cbhv->infocb.dsve.ve[atoi(dsve[i])]);
					}
					char nd[40] = "HUY TAT CA VE THANH CONG";
					THONG_BAO(nd);
					cn = 0; chon = -1; huytungve = false;
					break;
				}
				gotoxy(150, 35); cout << "                          ";
				gotoxy(150, 36); cout << "                          ";
				gotoxy(150, 37); cout << "                          ";
				gotoxy(2, 29); cout << "BAM TAB DE TRO VE CHON CB";
				huytungve = 0;
			}
			chon = chon_cb(dsve, 72 + 55 - 4, 13, max, yh, dau);
			if (chon == -27 && dau < 0) {
				free_char(ndbang, 4);
				free_char(dscb, dem);
				free_char(dsve, max);
			...
			if (chon >= 0) {
				delete_ve(cbhv, cbhv->infocb.dsve.ve[atoi(dsve[chon])]);
				gotoxy(150, 40); cout << "DA HUY VE " << dsve[chon] <<" TREN CHUYEN BAY " <<cbhv->infocb.maCB;
				Sleep(1000);
				gotoxy(150, 40); cout << "                                               ";
			}
			break;
...
void CHON_DATE(int& ngay, int& thang, int& nam, int x, int y, int cn) {
	...
	while (1) {
		...
		case 3: {
			...
			char a = ROLL_NUM(nam, namhientai + 3, namhientai - 3, x + 30, y, xnam, y);
			if (a == trai) {
				chon = 2;
			}
...
void DSCB_TG_SBD(int d, int m, int y, char* sbd, PTR_CB First, int xx, int yy) {
	...
	if (p->infocb.date_time.nam != y || p->infocb.date_time.thang != m || p->infocb.date_time.ngay != d) {//truong hop vong while tren trung sbd nhung thoi gian cua p < time hien tai
		char tb[40] = "KHONG CO CHUYEN BAY NAO HOP LE!";
		BOX(xx, 20, 50, 4, 7, 0, tb);
		TB_ESC();
		Xoa_n_BOX(xx, 20, 50, 4, 1);
	...
	while (strcmp(sbd, p->infocb.san_bay_den) != 0) {
		if (p->infocb.date_time.nam < y || p->infocb.date_time.thang < m || p->infocb.date_time.ngay < d || p->next == NULL) {
			char tb[40] = "KHONG CO CHUYEN BAY NAO HOP LE!";
			BOX(xx, 20, 50, 4, 7, 0, tb);
			TB_ESC();
			Xoa_n_BOX(xx, 20, 50, 4, 1);
	...
	while (1) {
		if (kt == 1) {
			count = 0; yh = 2;
			for (PTR_CB pp = p;pp != NULL && pp->infocb.date_time.ngay == d && pp->infocb.date_time.thang == m && pp->infocb.date_time.nam == y ; pp = pp->next) {
...
void IN_DSVE_CT(PTR_CB First) {
	if (First == NULL) {
		...
		if (p == NULL) {
			...
			if (p->infocb.status == 2) {
				char nd[30] = "KHONG CO VE NAO TRONG";
				THONG_BAO(nd);
			}
			else {
				XOA_MH();
...
bool TB_THOAT() {
	...
	SetColor(4); gotoxy(6, 31); cout << "ESC"; SetColor(7);
	char a = getch();
	gotoxy(5, 30); cout << "                    ";
	gotoxy(2, 31); cout << "                ";
	gotoxy(2, 32); cout << "                       ";
